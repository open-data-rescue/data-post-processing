...
def check_1_command(entry):
    ...
    return (raw_data_sql[:len(raw_data_sql) - 1] + " WHERE annotation_id = {} ORDER BY observation_date "
            "desc".format(annotation_id))
...
#  retrieves relevant field_id's in ledger sheet, to calculate particular field_id based on other two elements,
#  using equation 1, 2 oe 3 (PHASE 2)
